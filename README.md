...
This research is published for educational and defensive purposes. The vulnerabilities demonstrated here highlight critical security considerations for MCP implementations and should be addressed in production systems.

## 🤝 Contributing

Contributions to improve the demonstrations or add new attack vectors are welcome. Please:

1. Fork the repository
2. Create a feature branch
3. Add clear documentation for any new vulnerabilities
...
This repository is intended for security research and educational purposes only. The authors are not responsible for any misuse of the information or code provided. Always obtain proper authorization before testing security vulnerabilities on systems you do not own.
